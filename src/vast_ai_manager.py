...
def create_instance(id_i, bid, label, base_seed, cfg):
    create_command = [
        ...
        '--onstart-cmd',
        'cd ~/neural-render && git pull && nohup python3 src/generate.py ' +
        '{} --seed {} {}'.format(
...
def main():
    ...
    while True:
        ...
        for (dlperf_per_total_cost, this_total_cost, effective_dl_perf,
            ...
            if add_instance:
                ...
                if is_existing:
                    ...
                    print("bidding up:", label, "to", this_total_cost)
                    ...
                    instances[label] = InstanceInfo(dlperf_per_total_cost,
                                                    ...
                                                    time.time(), base_seed)
                    print("creating new instance:", label)
        ...
        for label in instance_labels:
            ...
            print(label, "at seed", instance.base_seed,
                  "perf/cost:", instance.dlperf_per_total_cost, "total cost:",
